...
<div class="container py-5">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form id="carrito-form" action="{{ route('carrito.agregar', $producto->id) }}" method="POST">
                @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Mostrar alerta al agregar al carrito
        carritoForm.addEventListener('submit', function(event) {
            event.preventDefault(); // Evitar envío automático para mostrar la alerta
