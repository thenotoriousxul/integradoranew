...
<div class="container mt-5" style="background-color: #1f2937; padding: 2rem; border-radius: 2rem;">
    ...
    <form action="/admin/producto/agregar/producto" method="POST" enctype="multipart/form-data" style="background-color: #dde3eb; padding: 2rem; border-radius: 0.5rem;" class="shadow border" >
        @csrf
