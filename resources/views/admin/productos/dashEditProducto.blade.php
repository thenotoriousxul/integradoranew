    ...
    <div class="container mt-5" style="background-color: #f8f9fa; padding: 2rem; border-radius: 0.5rem;">
        ...
        <form action="{{route ('actualizar.producto', $producto->id) }}" method="POST" enctype="multipart/form-data" style="background-color: #ffffff; padding: 2rem; border-radius: 0.5rem;" class="shadow-sm border">
            ...
            <div class="mb-4">
                ...
                <input value="{{$producto->tipo}}" type="text" name="tipo" id="tipo" class="form-control border rounded" placeholder="Tipo de producto" required style="background-color: #e9ecef; color: #495057;">
            </div>
    
            <div class="mb-4">
                <label class="form-label fw-semibold text-dark" for="talla">Ingresa la talla</label>
                <select name="talla" id="talla" class="form-select border rounded" required style="background-color: #e9ecef; color: #495057;">
                    <option value="" disabled selected>Selecciona un talla</option>
                    <option value="CH">CH</option>
                    <option value="M">M</option>
                    <option value="S">XL</option>
                    <option value="XL">XXL</option>
                </select>
                <small class="text-muted">ingresa La talla.</small>
            </div>
            ...
            <div class="mb-4">
                ...
                <small class="text-muted">Ingresa el color.</small>
            </div>
    
            <div class="mb-4">
                <label class="form-label fw-semibold text-dark" for="lote">Ingresa la cantidad de lote</label>
                <input value="{{$producto->lote}}" type="number" name="lote" id="lote" class="form-control border rounded" placeholder="Cantidad de lote" required style="background-color: #e9ecef; color: #495057;">
            </div>
    
            <div class="mb-4">
                <label class="form-label fw-semibold text-dark" for="costo">Ingresa el costo base</label>
                <input value="{{$producto->costo}}" type="text" name="costo" id="costo" class="form-control border rounded" placeholder="Costo base" required style="background-color: #e9ecef; color: #495057;">
            </div>
